...
Const TitleString = 'KeyTest    Version 1.6';
...
Var ScreenP: RasterPtr;       { Pointer to the screen for RasterOp }

Const ScreenWidth = 48;       { Number of words across the screen }


{ This is a RasterOp template
{
{ RasterOp(<Func>,<Width>,<Height>,<DestX>,<DestY>,ScreenWidth,ScreenP,
{  <src    <SrcX>,<SrcY>,ScreenWidth,ScreenP);
{ }
...
*)
    ...
    RasterOp(RXOr,768,1024,0,0,ScreenWidth,ScreenP,0,0,ScreenWidth,ScreenP);
  ...
  var XLen, YLen, TmpX, TmpY: Integer;
    ...
    case Key.Shape of
        Square: begin
            ...
            RasterOp(Func1, XLen, YLen, Key.X, Key.Y, ScreenWidth, ScreenP,
                   Key.X, Key.Y, ScreenWidth, ScreenP);
            RasterOp(Func2, XLen - 4, YLen - 4, Key.X + 2, Key.Y + 2,
                   ScreenWidth, ScreenP, Key.X + 2, Key.Y + 2, ScreenWidth,
                   ScreenP);
            end {Square};
        ...
        TabKey: begin
            ...
            RasterOp(Func1, XLen, YLen, TmpX, TmpY, ScreenWidth, ScreenP,
                   TmpX, TmpY, ScreenWidth, ScreenP);
            RasterOp(Func2, XLen - 4, YLen - 4, TmpX + 2, TmpY + 2,
                   ScreenWidth, ScreenP, TmpX + 2, TmpY + 2, ScreenWidth,
                   ScreenP);
            XLen := XSquareLength * 2;
...
while True do
    ...
    if Index = -1 then
        ...
        RasterOp(RNot,(Length(Sdum) * 9) + 6, 13 + 6, X - 3, Y - 13 - 3,
                 ScreenWidth, ScreenP, X - 3, Y - 13 - 3,
                 ScreenWidth,ScreenP);
        Pressed := False;
        while not Pressed do GetInput(Ch,TabX,TabY,Pressed);
        ...
        case Index of
            ...
            4: begin
               ...
               *)
               RasterOp(RXOr,768,1024,0,0,ScreenWidth,ScreenP,0,0,ScreenWidth,
                        ScreenP);
               SSetCursor(10,500);
               exit(KeyTest);
               end;
