...
namespace PERQemu.IO
{
    ...
    public class CanonController
    {
        ...
        void InterfaceReset()
        {
            ...
            Log.Debug(Category.Canon, "Interface (software) reset");
        }
        ...
        /// For what remains of my sanity, these are active true; the returned
        /// bits are inverted so the microcode sees the polarity it expects.
        /// </remarks>
        void UpdateStatus()
        {
            var ostatus = _status;
        ...
        public void LoadCommand(int value)
        {
            ...
            {
                Log.Debug(Category.Canon, "ReadStatus command!");
            ...
            if (_print && !_running)
            {
                Log.Debug(Category.Canon, "StartPage command!");
        ...
        {
            Log.Detail(Category.Canon, "[Controller SM  IN state={0} next={1}]", _state, next);
            ...
            else
            {
                ...
                Log.Info(Category.Canon, "[Printer not Ready, aborting]");
                UpdateStatus();
                SetInterrupt(true);
            ...
            _state = next;
            Log.Detail(Category.Canon, "[Controller SM OUT state={0}]", _state);
        }
